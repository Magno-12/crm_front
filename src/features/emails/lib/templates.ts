...
const HERO_RENTA_URL = `${CLD}/f_auto,q_auto:best,c_fill,g_auto,w_1360,h_620,e_improve,e_saturation:25,e_contrast:14,e_sharpen:90/proyectamos/hero_renta.jpg`;
